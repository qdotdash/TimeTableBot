...
client.on('ready', () => {
  ...
  cron.schedule("* * * * *", function() {
    const channel = client.channels.cache.get('756283093173797035');
    var d = new Date();
    var n = d.getDay()
